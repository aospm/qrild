...
struct qrild_svc_uim_card_status *qrild_svc_uim_get_card_status_resp_get_status(struct qrild_svc_uim_get_card_status_resp *uim_get_card_status_resp)
{
	...
	cs->index_gw_primary = *(uint16_t*)(ptr); ptr+=2;
	cs->index_1x_primary = *(uint8_t*)(ptr); ptr += 1;
...
struct qrild_svc_uim_card_status *qrild_svc_uim_get_card_status_resp_get_status_packed(struct qrild_svc_uim_get_card_status_resp *uim_get_card_status_resp)
{
	size_t buf_sz, len = 0, amt, i;
	uint8_t *ptr;
	struct qrild_svc_uim_card_status *cs;
